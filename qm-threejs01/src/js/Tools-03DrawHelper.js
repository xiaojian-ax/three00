...
//
    ...
    var defaultBillboard = {
        iconUrl: "/static/sampledata/images/DrawHelper/dragIcon.png",
        shiftX: 0,
        shiftY: 0
    }
    ...
    var dragHalfBillboard = {
        iconUrl: "/static/sampledata/images/DrawHelper/dragIconLight.png",
        shiftX: 0,
        shiftY: 0
    }
    ...
    _.prototype.LonlatPointsTerrainData = function(lonlats, callback,terrainProvider){
        ...
        mouseHandler.setInputAction(function(movement) {
            ...
            if(movement.position != null) {
                ...
                if (cartesian) {
                    ...
                    var promise = Cesium.sampleTerrainMostDetailed(scene.terrainProvider, positions);
                    var lat = Cesium.Math.toDegrees(cartographic.latitude);
                    var lon =  Cesium.Math.toDegrees(cartographic.longitude);
                    var height = 0;
                    Cesium.when(promise, function(samples) {
                        height = samples[0].height;
                         //cartesian = Cesium.Cartesian3.fromDegrees(cartographic.longitude,cartographic.latitude,height);
                        //经度纬度转笛卡尔
                        var cartographic1=Cesium.Cartographic.fromDegrees(lon,lat, height);
                        var cartesian3=ellipsoid.cartographicToCartesian(cartographic1); // 和 cartesianToCartographi相反
                        if(circle == null) {
                            // create the circle
    ...
    _.DrawHelperWidget = (function() {
        ...
        function _(drawHelper, options) {
            ...
            var drawOptions = {
                markerIcon: "/static/sampledata/images/DrawHelper/glyphicons_242_google_maps.png",
                polylineIcon: "/static/sampledata/images/DrawHelper/glyphicons_097_vector_path_line.png",
                polygonIcon: "/static/sampledata/images/DrawHelper/glyphicons_096_vector_path_polygon.png",
                circleIcon: "/static/sampledata/images/DrawHelper/glyphicons_095_vector_path_circle.png",
                extentIcon: "/static/sampledata/images/DrawHelper/glyphicons_094_vector_path_square.png",
                clearIcon: "/static/sampledata/images/DrawHelper/glyphicons_067_cleaning.png",
            ...
            var scene = drawHelper._scene;
            var cesiumWidget = drawHelper._cesiumWidget
            ...
            addIcon('clear', options.clearIcon, 'Remove all primitives', function() {
               // console.log("removeall");
                ...
                cesiumWidget.dataSources.removeAll();
